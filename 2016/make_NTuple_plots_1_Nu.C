...
void make_NTuple_plots_1_Nu(){
  ...
  cYZVertex->cd(3);
  TH2F *hYZVertex3 = new TH2F("hYZVertex3","Number of particles in y-z plane with more than zero hits;z;y",100,-100,600,100,-700,700);
  tree1->Draw("yTruths:zTruths >> hYZVertex3",NHitsGT0);
  hYZVertex3->Draw("colz");
  cYZVertex->cd(4);
  TH2F *hYZVertex4 = new TH2F("hYZVertex4","Number of particles in y-z plane with zero hits;z;y",100,-100,600,100,-700,700);
  tree1->Draw("yTruths:zTruths >> hYZVertex4",NHits0);
  ...
  cXYVertex->cd(2);
  TH2F *hXYVertex2 = new TH2F("hXYVertex2","Number of particles in x-y plane with more than twenty hits;y;x",-600,-650,650,100,-450,450);
  tree1->Draw("xTruths:yTruths >> hXYVertex2",NHitsGT20);
  hXYVertex2->Draw("colz");
  cXYVertex->cd(3);
  TH2F *hXYVertex3 = new TH2F("hXYVertex3","Number of particles in x-y plane with more than zero hits;y;x",100,-700,700,100,-700,700);
  tree1->Draw("xTruths:yTruths >> hXYVertex3",NHitsGT0);
  hXYVertex3->Draw("colz");
  cXYVertex->cd(4);
  TH2F *hXYVertex4 = new TH2F("hXYVertex4","Number of particles in x-y plane with zero hits;y;x",100,-700,700,100,-700,700);
  tree1->Draw("xTruths:yTruths >> hXYVertex4",NHits0);
  ...
  cXZVertex->cd(3);
  TH2F *hXZVertex3 = new TH2F("hXZVertex3","Number of particles in x-z plane with more than zero hits;z;y",100,-100,600,100,-700,700);
  tree1->Draw("xTruths:zTruths >> hXZVertex3",NHitsGT0);
  hXZVertex3->Draw("colz");
  cXZVertex->cd(4);
  TH2F *hXZVertex4 = new TH2F("hXZVertex4","Number of particles in x-z plane with zero hits;z;y",100,-100,600,100,-700,700);
  tree1->Draw("xTruths:zTruths >> hXZVertex4",NHits0);
  hXZVertex4->Draw("colz");

  TCanvas *cXTVertex = new TCanvas("cXTVertex","XTVertex");
  cXTVertex->Divide(2,1);
  cXTVertex->cd(1);
  TH2F *hXTVertex1 = new TH2F("hXTVertex1","x against t for more than zero hits;t;x",100,-2500e3,2500e3,100,-700,700);
  tree1->Draw("xTruths:tTruths >> hXTVertex1",NHitsGT0);
  hXTVertex1->Draw("colz");
  cXTVertex->cd(2);
  TH2F *hXTVertex2 = new TH2F("hXTVertex2","x against t for zero hits;t;x",100,-2500e3,2500e3,100,-700,700);
  tree1->Draw("xTruths:tTruths >> hXTVertex2",NHits0);
  hXTVertex2->Draw("colz");
